...
import { CreditCard, Wallet, Building2, Plus, Edit, Trash2, Save, X } from 'lucide-react'
...
interface PaymentMethodConfig {
  id: string
  name: string
  provider: 'paypal' | 'bank_transfer' | 'azul'
  isActive: boolean
  ...
  return (
    <div className='space-y-6'>
      <ContentSection
        ...
        desc='Configura los métodos de pago disponibles para tus clientes'
      >
